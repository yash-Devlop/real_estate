...
$(function () {
    var options = {
        ...
        series: [{
            name: 'Bookings',
            data: [0, 0, 0, 0, 0, 0, 0, 0, 0, 7000, 3000, 1000] // Example Data
        }],
        xaxis: {
            categories: ['Mar 2024', 'Apr 2024', 'May 2024', 'Jun 2024', 'Jul 2024', 'Aug 2024', 'Sep 2024', 'Oct 2024', 'Nov 2024', 'Dec 2024', 'Jan 2025', 'Feb 2025']
        },
        stroke: {
            width: 2
        },
...
$(function () {
    var options = {
        ...
        series: [
            {
                ...
                data: [0, 0, 0, 0, 0, 0, 0, 0, 2, 10, 20, 40] // Example Data
            },
            {
                name: 'Total Bookings',
                data: [0, 0, 0, 0, 0, 0, 0, 0, 10, 20, 50, 30] // Example Data
            },
            {
                name: 'Not Booking',
                data: [0, 0, 0, 0, 0, 0, 0, 0, 5, 15, 200, 400] // Example Data
            }
        ...
        colors: ['#00adb9', '#00ba27', '#fca307'], // Custom Colors
        legend: {
            position: 'top'
        },
        plotOptions: {
        ...
        dataLabels: {
            enabled: false // 🔥 Hides the numbers inside the bars
        }
    };
...
$(document).ready(function () {
    ...
    var moneSelectbySearch = new Choices('.oneselect', {
        removeItemButton: true,
         maxItemCount:1,
        searchResultLimit: 5,
        renderChoiceLimit: 5
...
//             $(this).DataTable({
//                 "dom": 'lftip' // Hides the search box
//             });
//         }
//     });
// });
...
$(document).ready(function () {
    $(".propermodeBtn").click(function () {
      const $this = $(this);
      const $details = $this.siblings(".propermodeDetails");
  
      $details.slideToggle();
  
      const isExpanded = $this.attr("data-state") === "expanded";
      if (isExpanded) {
        $this.attr("data-state", "collapsed").text("Read More");
      } else {
        $this.attr("data-state", "expanded").text("Read Less");
      }
    });
  });